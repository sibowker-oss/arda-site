    ...
    <section className="ms-hero" id="top">
      <div className="ms-hero-inner">
        <div className="ms-hero-copy">
          <div className="t-eyebrow t-eyebrow--lime">Sovereign AI · {isEnergy ? "energy & utilities" : "banking & insurance"}</div>
          ...
          <div className="ms-hero-actions">
            <a className="btn btn-flare btn-lg" href="#cta">Book a deep-dive<span className="arr"/></a>
